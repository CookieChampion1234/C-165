...
label_planet_image = Label(root, bg="gold2", highlightthickness=5, border=2, relief=SOLID)
...
def planetInfo():
    ...
    if planet == "Mercury":
        ...
        label_planet_gravity_radius["text"] = "Gravity : 3.7 m/s^2 /n Radius : 2439.7 km"
        label_planet_info["text"] = "Mercury is the smallest planet in our solar system. It's just a little bit bigger than Earth's moon."
        
    elif planet == "Venus":
        label_planet_name['text'] = "Venus"
        label_planet_image["image"] = Venus
        label_planet_gravity_radius["text"] = "Gravity : 8.87 m/s^2 /n Radius : 6051.8 km"
        ...
        label_planet_image["image"] = Eartn
        label_planet_gravity_radius["text"] = "Gravity : 9.087 m/s^2 /n Radius : 6371 km"
        label_planet_info["text"] = "Earth is the only planet is the universe confirmed to host life, and it's the only one known for sure to have liquid on its surface."
